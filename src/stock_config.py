...
INPUT_FEATURES = [
    ...
    COL_GRAHAM_VALUE, COL_PE_VALUE, COL_PB_VALUE
]

TARGET_CLOSE = COL_CLOSE
TARGET_INTRINSICS = [COL_GRAHAM_VALUE, COL_PE_VALUE, COL_PB_VALUE]
